...
NORMALIZZA FRA 0 E 1 TUTTE (COSì I COEFFICIENTI SONO PARAGONABILI)
...
summary(lm(popularity~valence,db))
```


##Regressione multipla
Regressione (categoriche in dummy)
**VIF (<2) la funzione seleziona le variabili da mettere nel modello**
